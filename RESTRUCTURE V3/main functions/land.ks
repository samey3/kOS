...
//--------------------------------------------------------------------------/
	...
	//Move into equatorial orbit--------------------------|
		...
		//RUNPATH("RESTRUCTURE V3/intermediate functions/refineOrbit.ks", maxTimes, orbitLex).
		
	//----------------------------------------------------\
	//Execute the landing script--------------------------|
		SET STAGE_ID TO "LAND_START".
		RUNPATH("RESTRUCTURE V3/intermediate functions/land.ks", _landCoordinates). //Second parameter is periapsis from body center
