...
//---------------------------------------------------------------------------------/
	...
	IF((SHIP:POSITION - _targetCraft:POSITION):MAG < standOffDistance){
		RUNPATH("RESTRUCTURE V3/basic functions/moveToPoint.ks", _targetCraft, (SHIP:POSITION - _targetCraft:POSITION):NORMALIZED*standOffDistance, 0).
	}
	...
	RUNPATH("RESTRUCTURE V3/basic functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*100, 0).	
	RUNPATH("RESTRUCTURE V3/basic functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*100, 0). //Does it again to correct any error distance
	
	
	//---------------------------------\
	//Dock-----------------------------|
	RUNPATH("RESTRUCTURE V3/basic functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*3, 1).
