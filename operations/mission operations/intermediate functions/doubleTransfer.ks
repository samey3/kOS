...
//--------------------------------------------------------------------------/
	...
	//Temporary before we actually do the double transfer
	RUNPATH("operations/mission operations/intermediate functions/eject.ks", _currentBody:BODY).
	RUNPATH("operations/mission operations/intermediate functions/inject.ks", _targetBody).
	...
	//Executes the node
	//RUNPATH("operations/mission operations/basic functions/executeNode.ks", NODE(res["t"], res["radial"], res["normal"], res["prograde"])).	
