...
//---------------------------------------------------------------------------------/
	...
	RUNPATH("basic_functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*100, 0).	
	RUNPATH("basic_functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*100, 0). //Does it again to correct any error distance
	
	
	//---------------------------------\
	//Dock-----------------------------|
	RUNPATH("basic_functions/moveToPoint.ks", targ_port, targ_port:FACING:VECTOR*3, 1).
